...
function send() {
   /* get_word = document.getElementById("word").value;
    ...
    console.log("Palabra en minúscula = "+word);
    ...
    input_box = "<br>Answer: <input type='text' id='input_chexk_box'>"; 
    check_button = "<br><br><button class='btn btn-info' onclick='check()'>Comprobar</button>"; 
...
function chack(){ 
    ...
    if(question_turn == "player1"){ 
        ...
        question_turn = "player1";
        document.getElementById("player_question").innerHTML = "Turno para responder -"+player1_name
    }
